import JsHtmlSource from "../abstractions/source-base"


class JsHtmlNodeBufferSource extends JsHtmlSource {
    encoding: string;
    path: string;
    length: number;
    checksum: Int8Array;
    checksumAlgorithm: string;
    charAt(index: any): string {
...
Object.freeze(JsHtmlNodeBufferSource)
Object.freeze(JsHtmlNodeBufferSource.prototype)

export default JsHtmlNodeBufferSource
